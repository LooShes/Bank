    ...
    render() {
        return (
            <div id="operations">Operations: <br></br>
                ...
                <button id="deposit-btn" value="deposit" onClick={this.handleButtons}>Deposit</button>
                <button id="withdraw-btn" value="withdraw" onClick={this.handleButtons}>Withdraw</button>
            </div>
        )
    }
}
